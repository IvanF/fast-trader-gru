...
func Load() Config {
	...
	return Config{
		...
		ConfidenceThreshold:        floatEnv("CONFIDENCE_THRESHOLD", 0.55),
		KillConfidenceThreshold:    floatEnv("KILL_CONFIDENCE_THRESHOLD", 0.45),
		...
		MaxSLPct:                   floatEnv("MAX_SL_PCT", 0.008),
		MinTPPct:                   floatEnv("MIN_TP_PCT", 0.004),
		MaxTPPct:                   floatEnv("MAX_TP_PCT", 0.015),
